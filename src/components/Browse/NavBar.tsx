...
const BrowseNavbar: React.FC = () => {
  return (
    <nav className="bg-skin-fill text-skin-base p-4">
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <input
              type="text"
              placeholder="Search..."
              className="bg-skin-fill text-skin-base px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
