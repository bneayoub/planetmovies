...
import { Star, Calendar, List, X, Film, Users, PlayCircle, ThumbsUp, MessageCircle } from 'lucide-react';
...
const TVShowDetailsComponent: React.FC<TVShowDetailsProps> = ({ tvShow }) => {
  ...
  const navItems = [
    ...
    { id: 'seasons', label: 'Seasons', icon: List },
    { id: 'trailers', label: 'Trailers', icon: PlayCircle },
    { id: 'similar', label: 'Similar TV Shows', icon: ThumbsUp },
